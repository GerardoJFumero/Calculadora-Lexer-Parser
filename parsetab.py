...
_lr_productions = [
  ...
  ('expressions -> expression expressions','expressions',2,'p_calculate','Calculadora.py',98),
  ('expressions -> expression','expressions',1,'p_calculate','Calculadora.py',99),
  ('expressions -> empty','expressions',1,'p_calculate','Calculadora.py',100),
  ('expression -> CALCULATE RIGHTBRA expression LEFTBRA FIN','expression',5,'p_solution','Calculadora.py',104),
  ('expression -> expression MULTIPLY expression','expression',3,'p_expression_solutions','Calculadora.py',110),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_solutions','Calculadora.py',111),
  ('expression -> expression PLUS expression','expression',3,'p_expression_solutions','Calculadora.py',112),
  ('expression -> expression MINUS expression','expression',3,'p_expression_solutions','Calculadora.py',113),
  ('expression -> FACTORIAL expression','expression',2,'p_expression_solutions','Calculadora.py',114),
  ('expression -> INT','expression',1,'p_expressions_int_float','Calculadora.py',125),
  ('expression -> FLOAT','expression',1,'p_expressions_int_float','Calculadora.py',126),
  ('expression -> MINUS expression','expression',2,'p_negative','Calculadora.py',132),
  ('expression -> LEFTPAR expression RIGHTPAR','expression',3,'p_expressions_parenthesis','Calculadora.py',137),
  ('empty -> <empty>','empty',0,'p_empty','Calculadora.py',143),
]
